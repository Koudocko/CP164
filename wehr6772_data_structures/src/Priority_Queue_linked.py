...
class Priority_Queue:
    ...
    def insert(self, value):
        ...
        if self._rear is None:
            self._rear = self._front = _PQ_Node(value, None)
            ...
            if previous is not None:
                previous._next = _PQ_Node(value, previous._next)
    ...
    def _append_queue(self, source):
        ...
        if self._rear is None:
            self._front, self._rear = source._front, source._rear
        elif source._front._value >= self._rear._value:
            self._rear._next = source._front
            self._rear = source._rear
        else:
            while ( current is not None and
                    source._front._value >= current._value ):
                previous = current
                current = current._next

            if previous is not None:
                temp = previous._next
                previous._next = source._front
                source._rear = temp
