...
class List:
    ...
    def insert(self, i, value):
        ...
        if curr is not None and i == 1:
            curr._next = _List_Node(value, curr._next)

            if curr._next._next is None:
    ...
    def _linear_search(self, key):
        ...
        """
        # your code here
        current, previous = self._front, None
        index = 0
    ...
    def remove(self, key):
        ...
        """
        # your code here
        data = self._linear_search(key)

        if data[1] is None:
            value = None
        else:
            value = deepcopy(data[1]._value)

            if data[0] is None and data[1]._next is None:
                self._front = self._rear = None
            elif data[0] is None:
                self._front = data[1]._next
                data[1]._next = None
            elif data[1]._next is None:
                self._rear = data[0]
                self._rear._next = None
            else:
                data[0]._next = data[1]._next
                data[1]._next = None
    ...
    def remove_many(self, key):
        ...
        while curr is not None:
            if curr._value == key:
                if prev is None and curr._next is None:
                    self._front = self._rear = None
                    curr = None
                elif prev is None:
    ...
    def clean(self):
        ...
        """
        # your code here
        first, second = self._front, None

        while first is not None:
            second = first

            while second is not None and second._next is not None:
                if first._value == second._next._value:
                    if second._next._next is None:
                        self._rear = second
                        self._rear._next = None
                    else:
                        temp = second._next
    ...
    def __eq__(self, target):
        ...
        if self._count == target._count:
            ...
            while curr_self is not None and equals:
                equals = curr_self._value == curr_target._value
    ...
    def split(self):
        ...
        middle = (self._count // 2) - (1 if self._count % 2 == 0 else 0)
        ...
        target2._front = curr._next if curr is not None else None
        target2._rear = (self._rear if self._count > 1 else None)
